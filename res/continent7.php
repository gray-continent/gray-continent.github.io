        ...
        if ($ext) {
            ...
            if ($bp['comments']) {
                if ($imSettings['blog']['comments_source'] == 'wsx5') {
                    ...
                    echo "</div>";
                    echo "<script type=\"text/javascript\">continent7.boot.push('continent7.topic({ target: \\'#blog-topic\\', scrollbar: false})', false, 6);</script>\n";
                } else {
        ...
        for ($i = $start; $i < $end; $i++) {
            if ($imSettings['blog']['highlight_mode'] != 'none' && $start < $imSettings['blog']['highlighted_count'] && $i == $imSettings['blog']['highlighted_count']) {
                if ($imSettings['blog']['highlight_mode'] == 'slideshow' && $imSettings['blog']['highlighted_count'] - $start > 1 && $end - $start > 1) {
                    ...
                    echo "<script>continent7.boot.push(function () { continent7.blogHighlightedSlideshow.start(); });</script>";
                }
                echo "</div>";
            }
 ...
 * To use it, you must include __continent7.php__ in your code.
 * 
 ...
 * 
 * To use this class, you must include __continent7.php__ in your code.
 * 
        ...
        if (count($found_count)) {
            ...
            foreach ($found_products as $id => $product) {
                ...
                if (($i > $this->page*$this->results_per_page) && ($i <= ($this->page+1)*$this->results_per_page)) {
                    ...
                    $html .= "<span>" . $product['price'] . "<img src=\"cart/images/cart-add.png\" onclick=\"continent7.cart.ui.addToCart('" . $id . "', 1);\" style=\"cursor: pointer;\" /></span>";
                    $html .= "</div>";
...
class ImTopic
{
    ...
    function showForm($rating = true, $captcha = true)
    {
        ...
        echo "<div class=\"topic-form-row\" style=\"text-align: center\">
                ...
                <script type=\"text/javascript\">continent7.boot.push( function () { continent7.imForm.initForm('#" . $id . "', false, { 'jsid': '" . md5($this->id) . "', showAll: true }); });</script>
            </div>\n";
    }
