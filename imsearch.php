<?php require_once("res/continent7.php"); ?>
<!DOCTYPE html><!-- HTML5 -->
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>Поиск - GRAY CONTINENT</title>
		<meta charset="utf-8" />
		<!--[if IE]><meta http-equiv="ImageToolbar" content="False" /><![endif]-->
		<meta name="author" content="GRAY CONTINENT" />
		<meta name="generator" content="Incomedia WebSite X5 Professional 14.0.3.1 - www.websitex5.com" />
		<meta property="og:locale" content="en" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="http://continent.cf/imsearch.php" />
		<meta property="og:title" content="Поиск" />
		<meta property="og:site_name" content="GRAY CONTINENT" />
		<meta property="og:image" content="http://continent.cf/favImage.png" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-3-1-636877746105827482" media="screen,print" />
		<script type="text/javascript" src="res/jquery.js?14-0-3-1"></script>
		<script type="text/javascript" src="res/continent7.js?14-0-3-1" data-files-version="14-0-3-1"></script>
		<script type="text/javascript">
			window.onload = function(){ checkBrowserCompatibility('Your browser does not support the features necessary to display this website.','Your browser may not support the features necessary to display this website.','[1]Update your browser[/1] or [2]continue without updating[/2].','http://outdatedbrowser.com/'); };
			continent7.utils.currentPagePath = 'imsearch.php';
			continent7.boot.push(function () { continent7.utils.imCodeProtection('GRAY CONTINENT'); });
			continent7.boot.push(function () { continent7.imPageToTop.initializeButton({}); });
		</script>
		<link rel="icon" href="favicon.png?14-0-3-1-636877746105797481" type="image/png" />
	</head>
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">Поиск - GRAY CONTINENT</h1>
						<div id="imHeaderObjects"><div id="imHeader_imObjectImage_01_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_1" class="" > <div id="imHeader_imCellStyleGraphics_1"></div><div id="imHeader_imCellStyle_1" ><img id="imHeader_imObjectImage_01" src="images/caf23.png" title="" alt="" /></div></div></div><div id="imHeader_imObjectImage_02_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_2" class="" > <div id="imHeader_imCellStyleGraphics_2"></div><div id="imHeader_imCellStyle_2" ><img id="imHeader_imObjectImage_02" src="images/mail.png" title="" alt="" /></div></div></div></div>
					</div>
...
continent7.boot.push(function(){continent7.initMenu('imStickyBar_imMenuObject_03',1000)});
